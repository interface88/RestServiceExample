...
<body>
    ...
    <div id="wrapper">
		<form:form id="logoutform" action="${pageContext.request.contextPath}/perform_logout" method="POST">
		</form:form>
        <!-- Navigation -->
        <nav class="navbar navbar-inverse navbar-static-top" role="navigation">
            <div class="navbar-header">
              <a class="navbar-brand" href="${pageContext.request.contextPath}" style="padding-left:100px;">
                <img src="${pageContext.request.contextPath}/static/images/holcimlogo.png" width="160" height="80" />
              </a>    
            </div>
          <center><div class="nav navbar-top-links navbar-center" style="margin-top:40px;">
              <h2>Geostone-VR Application Admin Panel</h2>
               </div>
          </center>
            <!-- /.navbar-header -->
           
            <ul class="nav navbar-top-links navbar-right">
          <a href="#"  onclick="document.getElementById('logoutform').submit();" style="margin-bottom:20px;" >
          				<span style="font-size:18px;margin-bottom:20px;"><b>Login</b></span><i class="fa fa-sign-out fa-fw"style="font-size:35px;margin-bottom:20px;"> </i>
           			   </a>
                </ul>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                     <div class="avatar" style="align-content:center;">
						<center><i class='fas fa-user-circle' style='font-size:58px;color:blue'></i><br></center>
						<center><h6><b>S</b></h6></center>
					</div>
